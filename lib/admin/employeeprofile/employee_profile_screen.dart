...
class ViewAdminEmployeeProfileScreen extends StatefulWidget with TextFieldMixin {
  ...
  @override
  State<ViewAdminEmployeeProfileScreen> createState() => _ViewAdminEmployeeProfileScreen();
}

class _ViewAdminEmployeeProfileScreen extends State<ViewAdminEmployeeProfileScreen> {
                            ...
                            if (formKey.currentState!.validate()) {
                                ...
                                Timer(const Duration(seconds: 5), ()
                                {
                                  AppUtils.instance.showToast(
                                      toastMessage: "Employee Added");
                                  AddEmployeeFireAuth().addEmployee(
                                      email: data['email'],
                                      employeeName: data['employeeName'], mobile: data['mobile'],
